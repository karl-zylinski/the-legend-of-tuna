...
atlas_textures: [Texture_Name]Atlas_Texture = {
	.None = {},
	.Round_Cat = { rect = {253, 67, 20, 24}, offset_top = 0, offset_right = 0, offset_bottom = 0, offset_left = 0, document_size = {20, 24}, duration = 0.100},
...
atlas_glyphs: []Atlas_Glyph = {
	{ rect = {331, 35, 25, 30}, value = 'A', offset_x = 0, offset_y = 16, advance_x = 24},
	{ rect = {97, 37, 21, 30}, value = 'B', offset_x = 4, offset_y = 16, advance_x = 26},
	{ rect = {289, 1, 23, 32}, value = 'C', offset_x = 2, offset_y = 15, advance_x = 25},
	{ rect = {120, 36, 22, 30}, value = 'D', offset_x = 4, offset_y = 16, advance_x = 27},
	...
	{ rect = {144, 36, 22, 30}, value = 'H', offset_x = 4, offset_y = 16, advance_x = 29},
	...
	{ rect = {168, 36, 22, 30}, value = 'K', offset_x = 4, offset_y = 16, advance_x = 26},
	{ rect = {401, 67, 17, 30}, value = 'L', offset_x = 4, offset_y = 16, advance_x = 21},
	{ rect = {358, 35, 25, 30}, value = 'M', offset_x = 4, offset_y = 16, advance_x = 32},
	{ rect = {192, 36, 22, 30}, value = 'N', offset_x = 4, offset_y = 16, advance_x = 29},
	...
	{ rect = {70, 42, 21, 30}, value = 'R', offset_x = 4, offset_y = 16, advance_x = 25},
	{ rect = {339, 1, 22, 32}, value = 'S', offset_x = 1, offset_y = 15, advance_x = 24},
	{ rect = {46, 42, 22, 30}, value = 'T', offset_x = 1, offset_y = 16, advance_x = 24},
	...
	{ rect = {141, 68, 18, 24}, value = 'a', offset_x = 2, offset_y = 23, advance_x = 22},
	{ rect = {120, 1, 20, 33}, value = 'b', offset_x = 3, offset_y = 14, advance_x = 24},
	{ rect = {161, 68, 18, 24}, value = 'c', offset_x = 2, offset_y = 23, advance_x = 20},
	...
	{ rect = {233, 68, 19, 23}, value = 'n', offset_x = 3, offset_y = 23, advance_x = 24},
	...
	{ rect = {317, 67, 20, 30}, value = '2', offset_x = 1, offset_y = 16, advance_x = 22},
	{ rect = {487, 1, 20, 31}, value = '3', offset_x = 1, offset_y = 16, advance_x = 22},
	{ rect = {420, 67, 22, 29}, value = '4', offset_x = 0, offset_y = 17, advance_x = 22},
	{ rect = {339, 67, 20, 30}, value = '5', offset_x = 1, offset_y = 17, advance_x = 22},
	...
	{ rect = {462, 34, 20, 31}, value = '8', offset_x = 1, offset_y = 16, advance_x = 22},
	{ rect = {484, 34, 20, 31}, value = '9', offset_x = 1, offset_y = 16, advance_x = 22},
	{ rect = {233, 35, 20, 31}, value = '0', offset_x = 1, offset_y = 16, advance_x = 22},
	...
	{ rect = {75, 1, 9, 39}, value = '[', offset_x = 4, offset_y = 14, advance_x = 13},
	{ rect = {86, 1, 9, 39}, value = ']', offset_x = 1, offset_y = 14, advance_x = 13},
